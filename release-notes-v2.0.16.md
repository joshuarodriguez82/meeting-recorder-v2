...
- Internal domain (your own `@[scrubbed].com`) is auto-detected as the one that appears in the most sessions and excluded — otherwise every client would look like a match.
