# v2.7.6 — Co-Pilot polish: in-bar toggle, scrolling history, persisted in the session

Follow-up release. Builds on the Live Co-Pilot (beta) shipped in v2.7.5
with the things that actually make it usable across a real meeting.

## Install (macOS)

> v2.7.6 ships **a single universal `.zip`** that runs on every Mac
> (Apple Silicon and Intel). On the [Releases page](https://github.com/joshuarodriguez82/meeting-recorder-v2/releases),
> grab `Meeting.Recorder_2.7.6_universal.zip`.
>
...
> ```sh
> cd ~/Downloads
> unzip -o Meeting.Recorder_2.7.6_universal.zip
> mv "Meeting Recorder.app" /Applications/
> xattr -cr "/Applications/Meeting Recorder.app"
> open "/Applications/Meeting Recorder.app"
> ```
>
> **Windows users**: download `Meeting.Recorder_2.7.6_x64-setup.exe`
