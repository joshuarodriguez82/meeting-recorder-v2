# v2.7.3 — Screenshot window fix + one-click update (ships v2.7.2 content correctly)

Patch release. The previous **v2.7.2** tag was pushed against the v2.7.1
commit by accident (before the v2.7.2 PR had merged), so its build
contained v2.7.1 binaries — anyone who installed v2.7.2 saw "2.7.1" in
the app. **v2.7.3 is the actual v2.7.2 content**, built from the right
commit. All v2.7.1 / v2.7.0 features are included.

## Install (macOS)

> v2.7.3 ships **a single universal `.zip`** that runs on every Mac
> (Apple Silicon and Intel). On the [Releases page](https://github.com/joshuarodriguez82/meeting-recorder-v2/releases),
> grab `Meeting.Recorder_2.7.3_universal.zip`.
>
...
> ```sh
> cd ~/Downloads
> unzip -o Meeting.Recorder_2.7.3_universal.zip
> mv "Meeting Recorder.app" /Applications/
> xattr -cr "/Applications/Meeting Recorder.app"
> open "/Applications/Meeting Recorder.app"
> ```
>
> **Windows users**: download `Meeting.Recorder_2.7.3_x64-setup.exe`
...
- The mis-tagged v2.7.2 release on GitHub contains v2.7.1 binaries. It
  can be safely deleted; v2.7.3 supersedes it.
