# v2.7.8 — Co-Pilot polish: in-bar toggle, scrolling history, persisted in the session

> **v2.7.6 and v2.7.7 were both bad cuts** — both tags were pushed at
> a commit that predated the version bump, so their Windows installers
> shipped with `2.7.4_*` filenames and the actual Co-Pilot
> improvements weren't in the binary. **Install this release instead.**
...
> v2.7.8 ships **a single universal `.zip`** that runs on every Mac
> (Apple Silicon and Intel). On the [Releases page](https://github.com/joshuarodriguez82/meeting-recorder-v2/releases),
> grab `Meeting.Recorder_2.7.8_universal.zip`.
>
...
> ```sh
> cd ~/Downloads
> unzip -o Meeting.Recorder_2.7.8_universal.zip
> mv "Meeting Recorder.app" /Applications/
> xattr -cr "/Applications/Meeting Recorder.app"
> open "/Applications/Meeting Recorder.app"
> ```
>
> **Windows users**: download `Meeting.Recorder_2.7.8_x64-setup.exe`
