...
DOCUMENT_HIT = {
    ...
    "doc_path": "~/Knowledge/ACME/ACME_SOW_v3.docx",
    "client": "ACME",
    "text": "Cutover is scheduled for the first weekend of October 2026. "
            "[scrubbed] Digital provides 40 hours of hypercare.",
    "similarity": 0.7710,
}
...
CLIENT_CONFIGS = {
    "ACME": {
        "export_folder": "~/Drive/ACME/Exports",
        "knowledge_folder": "~/Knowledge/ACME",
        "display_name": "ACME Health",
    },
    # The double-indexing trap: knowledge folder == export folder.
    "Globex": {
        "export_folder": "~/Drive/Globex/Exports",
        "knowledge_folder": "~/Drive/Globex/Exports",
        "display_name": "Globex",
    },
    "Initech": {
        "export_folder": "",
...
FULL_SESSION: Dict[str, Any] = {
    ...
    "project": "CCaaS Migration",
    "template": "Discovery",
    "attendees": ["priya@acme.example", "josh@[scrubbed].example"],
    "notes": "Priya joined 10 minutes late; the Genesys license question "
             "is still open.",
    "speakers": {
        "SPEAKER_00": {"display_name": "[scrubbed]"},
