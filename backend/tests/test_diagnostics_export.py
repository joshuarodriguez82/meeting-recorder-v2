...
class _Settings:
    ...
    email_to: str = "[scrubbed]@example.com"
    recordings_dir: str = r"C:\Users\[scrubbed]\AppData\Local\MeetingRecorder"
...
def test_zip_contains_no_secrets_or_transcript_text(tmp_path, monkeypatch):
    ...
    for forbidden in (
        ...
        "[scrubbed]@example.com",  # email
        "[scrubbed]",                      # username inside paths
        "Contoso",                         # client name
        "Jane Doe",                        # a person
    ):
